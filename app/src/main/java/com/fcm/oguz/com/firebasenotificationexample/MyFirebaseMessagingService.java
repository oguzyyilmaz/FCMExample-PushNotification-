...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) { // Data mesajı içeriyor mu
            ...
            sendNotification("FCM", "" + remoteMessage.getData().get("message") + "\n size : " + remoteMessage.getData().get("size"));
        ...
        if (remoteMessage.getNotification() != null) { //Notification mesajı içeriyor mu
            ...
            System.out.println("Mesaj Notification Başlığı: " + remoteMessage.getNotification().getTitle() + " " + "Mesaj Notification İçeriği: " + remoteMessage.getNotification().getBody());
